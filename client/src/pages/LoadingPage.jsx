const LoadingPage = () => {
  return (
    <div className="w-screen h-screen flex flex-col justify-center items-center text-orange-500">
        ...
        >
          ...
          <g>
            <linearGradient id="linear-gradient">
              <stop offset="0%" stopColor="#eb8334" />
          ...
          <circle fill="#eb8334" cx="55.641" cy="97.563" r="6.047">
            <animate
